...
pacman::p_load(tidyverse, tidymodels, workflows, tune)
...
my_formula_1 <- as.formula(SINIESTRO ~ PERIDO + COVER + SEXO + FUMADOR + BUENA_SALUD + EDAD_ACTUARIAL + EXP + DURACION + CAPITAL + IMC)
my_formula_2 <- as.formula(SINIESTRO ~ PERIDO + COVER + SEXO + FUMADOR + BUENA_SALUD + EDAD_SUS + EXP + DURACION + CAPITAL + IMC)
