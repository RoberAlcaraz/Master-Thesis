...
```{r}
table(insurance$period)/nrow(insurance)

insurance %>%
  ggplot(aes(x = period)) +
  geom_bar() 

tab <- table(insurance$period, insurance$mortality)
...
tab <- table(insurance$cover, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
tab <- table(insurance$sex, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
tab <- table(insurance$smoker, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance %>%
  ...
  geom_bar() 
tab <- table(insurance$good_health, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
tab <- table(insurance$capital_factor_1, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance %>%
  ...
  geom_bar() 
tab <- table(insurance$capital_factor_2, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance %>%
  ...
  geom_bar() 
tab <- table(insurance$capital_factor_3, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
# convert it to dummy
```
...
tab <- table(insurance$IMC_factor_1, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
tab <- table(insurance$IMC_factor_2, insurance$mortality)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
(a <- cor(insurance[, c(8, 10, 12, 14, 18)]))
corrplot::corrplot(a)
