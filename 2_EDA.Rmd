...
pacman::p_load(tidyverse, tidymodels, workflows, tune, patchwork, FactoMineR, dotwhisker)
theme_set(theme_bw())
...
insurance_split <- initial_split(insurance, prop = 0.7, strata = accident)
...
```{r}
rec <- 
  recipe(accident ~ period + cover + sex + smoker + good_health + actuarial_age + exp +
