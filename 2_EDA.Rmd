...
insurance_train %>%
  ...
  geom_bar()
tab <- table(insurance_train$period, insurance_train$cover)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance_train %>%
  ...
  geom_bar()
tab <- table(insurance_train$period, insurance_train$sex)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance_train %>%
  ...
  geom_bar()
tab <- table(insurance_train$period, insurance_train$smoker)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))

# NO
insurance_train %>%
  ggplot(aes(x = period, fill = good_health)) +
  geom_bar()
tab <- table(insurance_train$period, insurance_train$good_health)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance_train %>%
  ...
  geom_bar()
tab <- table(insurance_train$cover, insurance_train$sex)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
insurance_train %>%
  ...
  geom_bar()
tab <- table(insurance_train$cover, insurance_train$smoker)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))

# YES
insurance_train %>%
  ggplot(aes(x = cover, fill = good_health)) +
  geom_bar()
tab <- table(insurance_train$cover, insurance_train$good_health)*100/nrow(insurance_train)
cbind(tab, tab[, 2] / (tab[, 1] + tab[, 2]))
...
```{r}
h <- bw.SJ(x = insurance_train$capital, method = "dpi")

insurance_train %>%
  ggplot(aes(x = capital, color = cover, fill = cover)) +
  scale_x_log10() +
...
```{r}
max_model <- glm(mortality ~ (period + cover + sex + smoker + good_health + actuarial_age + capital + IMC)^2 
                 - actuarial_age:capital - actuarial_age:IMC - capital:IMC, 
